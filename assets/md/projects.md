...
A full-stack web clone of ProtectedText.com with secure note storage, featuring a Bootstrap frontend and Django backend architecture.
...
A clean web utility engineered to generate shortened URLs while demonstrating core routing and templating in Flask.
...
An interactive 2D arcade game featuring dynamic maze navigation, obstacle collision mechanics, and live score tracking.
...
A conversational assistant built with Python utilizing predefined decision trees and rule-based logic processing.
...
A lightweight TTS utility built with Python 3 designed to generate voice audio completely offline without external APIs.
...
A lightweight `.mcfunction` datapack providing real-time, accurate actionbar coordinate tracking during gameplay.

🔗 [View Repository](https://github.com/MJTech46/MCDataPack-MJCoordinates)
